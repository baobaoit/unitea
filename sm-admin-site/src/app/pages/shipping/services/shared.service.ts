...
export class SharedService {
  ...
  getPackaging(param): Observable<any> {
    return this.crudService.get('/v1/private/shipping/packages', param);
  }
  ...
  // ************ Shipping Rules API NEW Start ***************
  getShippingModules(param): Observable<any> {
    return this.crudService.get('/v1/private/modules/shipping', param);
  }
  getShippingModulesDetails(type, param): Observable<any> {
    return this.crudService.get('/v1/private/modules/shipping/' + type, param);
  }
