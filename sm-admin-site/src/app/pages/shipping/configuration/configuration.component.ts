...
export class ConfigurationComponent {
  ...
  initService() {
    ...
    forkJoin([this.sharedService.getExpedition(this.selectedStore), this.storeService.getListOfMerchantStoreNames({ 'store': environment.merchantStore }), this.sharedService.getCountry()])
