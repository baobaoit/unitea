  ...
  setSettings() {
    ...
    this.settings = {
      ...
      columns: {
        ...
        compound: {
          title: this.translate.instant('TAX.COMPOUND'),
          type: 'html',
          valuePrepareFunction: (value) => { 
            return this._sanitizer.bypassSecurityTrustHtml(`<input type='checkbox' ${value ? 'checked' : ''} disabled>`);
          },
          filter: false
        },
        taxClass: {
