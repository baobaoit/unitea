...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        title: 'COMPONENTS.BUSINESS_HOURS',
        key: 'COMPONENTS.BUSINESS_HOURS',
        link: '/pages/store-management/business-hours',
        hidden: false,
        guards: [IsSuperadmin, IsAdmin]
      },
      {
        title: 'COMPONENTS.STORE_COORDINATE',
        key: 'COMPONENTS.STORE_COORDINATE',
        link: '/pages/store-management/store-coordinate',
        hidden: false,
        guards: [IsSuperadmin, IsAdmin]
      },
      {
        title: 'COMPONENTS.CONVENIENCE_FEE',
        key: 'COMPONENTS.CONVENIENCE_FEE',
        link: '/pages/store-management/convenience-fee',
        hidden: false,
        guards: [IsSuperadmin, IsAdmin]
      }
    ],
  ...
  },
  {
    ...
    children: [
      {
        title: 'COMPONENTS.TAX_CONFIGURATION',
        key: 'COMPONENTS.TAX_CONFIGURATION',
        link: '/pages/tax-management/tax-configuration'
      },
      {
  ...
  // },
  {
    ...
    children: [
      ...
      },
      {
        title: 'ORDER.ONGOING',
        key: 'ORDER.ONGOING',
        link: '/pages/orders/order-going',
        guards: [IsOrderManagementVisible]
      }
    ]
  },
  {
    title: 'COMPONENTS.TIP_MANAGEMENT',
    key: 'COMPONENTS.TIP_MANAGEMENT',
    icon: 'gift',
    guards: [IsSuperadmin, IsAdmin],
    link: '/pages/tip-management/list',
  },

  {
    title: 'COMPONENTS.REPORT_MANAGEMENT',
    key: 'COMPONENTS.REPORT_MANAGEMENT',
    icon: 'activity',
    guards: [IsSuperadmin, IsAdmin],
    children: [
      {
        title: 'TIP.TIPS',
        key: 'TIP.TIPS',
        link: '/pages/report-management/tips',
      }
    ]
  },
