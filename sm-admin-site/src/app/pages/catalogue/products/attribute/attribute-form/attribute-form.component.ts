...
export class AttributeFormComponent implements OnInit {
  ...
  constructor(
    ...
    forkJoin(this.optionService.getListOfOptions({ store: environment.merchantStore }), this.optionValuesService.getListOfOptionValues({ store: environment.merchantStore }))
