...
public class ReadableInventory extends InventoryEntity {
  ...
  private ReadableProductDimensions dimensions;

  public ReadableProductDimensions getDimensions() {
    return dimensions;
  }
  public void setDimensions(ReadableProductDimensions dimensions) {
