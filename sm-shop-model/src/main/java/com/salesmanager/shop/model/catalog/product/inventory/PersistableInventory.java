...
public class PersistableInventory extends InventoryEntity {
  ...
  private PersistableProductDimensions dimensions;
  public PersistableProductDimensions getDimensions() {
    return dimensions;
  }
  public void setDimensions(PersistableProductDimensions dimensions) {
