...
public interface OrderService extends SalesManagerEntityService<Long, Order> {
    ...
    OrderTotalSummary caculateOrderTotal(OrderSummary orderSummary,
										 Customer customer, CustomerTip customerTip,
     ...
     * @throws ServiceException
     */
    OrderTotalSummary caculateOrderTotal(OrderSummary orderSummary, CustomerTip customerTip,
	...
	/**
	 * Returns the total tips of the {@code store} since the first delivered order.
	 * @param store
	 * @return
	 */
