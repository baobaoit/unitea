...
public class Constants {
  ...
  public static final String OT_CUSTOMER_TIP_MODULE_CODE = "tip";

  public static final String BUSINESS_TIME_CONFIG = "BUSINESS_TIME_CONFIG";

  public static final String COORDINATE_CONFIG = "COORDINATE_CONFIG";

  public static final String CONTACT_EMAIL_CONFIG = "CONTACT_EMAIL_CONFIG";

  public static final String CONVENIENCE_FEE = "CONVENIENCE_FEE";
  public static final String OT_CONVENIENCE_FEE_MODULE_CODE = "conveniencefee";
}
