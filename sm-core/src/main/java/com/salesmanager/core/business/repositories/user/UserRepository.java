...
public interface UserRepository extends JpaRepository<User, Long>, UserRepositoryCustom {
	...
	@Query("from User u join u.groups ug join u.merchantStore um where ug.groupName in ?1 and um.id = ?2")
	List<User> findByGroupsAndStore(List<String> groups, Integer storeId);
