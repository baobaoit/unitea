...
public class PersistableInventoryMapper implements Mapper<PersistableInventory, ProductAvailability> {
  ...
  public ProductAvailability merge(PersistableInventory source, ProductAvailability destination,
    ...
    if (Objects.nonNull(source.getDimensions())) {
      PersistableProductDimensions productDimensions = source.getDimensions();
      ProductDimensions dimensions = new ProductDimensions();

      dimensions.setWidth(productDimensions.getWidth());
      dimensions.setWeight(productDimensions.getWeight());
      dimensions.setLength(productDimensions.getLength());
      dimensions.setHeight(productDimensions.getHeight());
