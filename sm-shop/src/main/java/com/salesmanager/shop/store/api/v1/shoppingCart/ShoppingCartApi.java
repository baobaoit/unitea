...
public class ShoppingCartApi {
	...
	public ResponseEntity<ReadableShoppingCart> deleteCartItem(@PathVariable("code") String cartCode,
			@PathVariable("id") Long itemId, @RequestParam(defaultValue = "") Set<Long> attributes, @ApiIgnore MerchantStore merchantStore,
			@ApiIgnore Language language, @RequestParam(defaultValue = "false") boolean body) throws Exception {

		ReadableShoppingCart updatedCart = shoppingCartFacade.removeShoppingCartItem(cartCode, itemId, attributes,
				merchantStore, language, body);
		if (body) {
	...
	@ApiOperation(httpMethod = "DELETE", value = "clear a specific cart")
	@ApiImplicitParams({ @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
			@ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en")})
	public ResponseEntity<Boolean> clearShoppingCart(@PathVariable("code") String cartCode, @ApiIgnore MerchantStore merchantStore,
									 @ApiIgnore Language language) throws Exception {
		return new ResponseEntity<>(shoppingCartFacade.clearShoppingCart(cartCode, merchantStore, language), HttpStatus.OK);
	}
}
