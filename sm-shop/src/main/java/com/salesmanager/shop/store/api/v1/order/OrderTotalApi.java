...
public class OrderTotalApi {
  ...
  @Inject private TaxRateDescriptionService taxRateDescriptionService;
  ...
  public ReadableOrderTotalSummary payment(
    ...
    try {
      ...
      if (shoppingCart.getCustomerId() == null) {
        response.sendError(
            404, "Cart id " + code + " does not exist for exist for user " + userName);
        return null;
      }
      ...
      orderTotalSummary = orderService.caculateOrderTotal(orderSummary, customer, customerTip, merchantStore, language);
      ...
      populator.setTaxRateDescriptionService(taxRateDescriptionService);
  ...
  public ReadableOrderTotalSummary calculateTotal(
    ...
    try {
      ...
      orderTotalSummary = orderService.caculateOrderTotal(orderSummary, customerTip, merchantStore, language);
