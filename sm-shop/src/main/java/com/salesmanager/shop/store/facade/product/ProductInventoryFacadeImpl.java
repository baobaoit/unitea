...
import com.salesmanager.shop.mapper.inventory.PersistableDimensionsMapper;
...
@Profile({"default", "cloud", "gcp", "aws", "mysql", "prod", "dev"})
public class ProductInventoryFacadeImpl implements ProductInventoryFacade {
  ...
  @Autowired
  private PersistableDimensionsMapper persistableDimensionsMapper;
  ...
  public void update(Long productId, PersistableInventory inventory, MerchantStore store,
    ...
    availability.setDimensions(persistableDimensionsMapper.convert(inventory.getDimensions(), store, language));
    inventory.setProductId(product.getId());

    availability.setSku(inventory.getSku());
