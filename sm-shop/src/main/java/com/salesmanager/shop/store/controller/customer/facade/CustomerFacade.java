...
public interface CustomerFacade
{
    ...
    boolean checkIfUserEmailExists(final String emailAddress, final MerchantStore store);
	...
	void setCustomerPassword(Customer target, String password);

	com.salesmanager.core.model.customer.Customer populateBillingAddress(Customer customer, BillingAddress billingAddress) throws ServiceException;
}
