...
public interface ShoppingCartFacade {
	 ...
	 */
	@Nullable
	ReadableShoppingCart removeShoppingCartItem(String cartCode, Long productId, Set<Long> attributes, MerchantStore merchant, Language language, boolean returnCart) throws Exception;

	boolean clearShoppingCart(String cartCode, MerchantStore merchant, Language language) throws Exception;
