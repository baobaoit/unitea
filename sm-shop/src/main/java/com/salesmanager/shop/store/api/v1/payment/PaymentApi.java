...
import com.salesmanager.shop.store.controller.notify.facade.NotifyFacade;
...
public class PaymentApi {
	...
	public void configure(
		...
		try {
			...
			authorizationUtils.authorizeUser(user, Collections.singletonList(Constants.GROUP_SUPERADMIN), merchantStore);
			...
			notifyFacade.updatePaymentMethod(integrationConfiguration, merchantStore,
					LocaleUtils.getLocale(merchantStore.getDefaultLanguage()), request);
		} catch (ServiceException e) {
			LOGGER.error("Error getting payment modules", e);
