				...
				<div id="login-box">
					...
					<div class="row">
						...
						<div style="float: right;">
							<img alt="go to www.shopizer.com" class="logo-top-right"
								src="<c:url value="/resources/img/hesman_ecommerce_logo_unbold.png" />">
						</div>
					</div>
							...
							<form method="post" id="logonForm" class="form-horizontal" action="<c:url value="/admin/performUserLogin"/>">
								...
								<div class="control-group form-group">
									<div class="controls recaptcha">
										...
										<div class="g-recaptcha" data-sitekey="<c:out value="${recaptcha_public_key}" />" />
									</div>
								</div>
