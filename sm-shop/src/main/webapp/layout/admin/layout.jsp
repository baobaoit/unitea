...
<div class="sm">
	<div class="container">
		...
		<div class="row">
  			...
  			<div class="span4"><a class="brand" href="#"><img class="logo" src="<c:url value="/resources/img/hesman_ecommerce_logo_unbold.png" />"/></a></div>
	...
	<div class="container"> 
		...
		<footer> 
 			<p>&copy; Developed by Hesmantech LLC</p>
		</footer> 
